...
def arg():
    ...
    target.add_argument("-f", "--file", dest="file", type=str, help="从文件读取多个URL进行批量扫描 (e.g. -f \"urls.txt\")")
    ...
    example.add_argument(action='store_false',
                         dest="python3 JSFinderPlus.py -u http://example.com\n  "
                              ...
                              "python3 JSFinderPlus.py -f urls.txt -d -t 20\n  "
                              "python3 JSFinderPlus.py -f urls.txt\n  "
                         )
